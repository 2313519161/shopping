...
public class UserController {
	...
	public String register(@ModelAttribute @Valid Buser buser,Model model, HttpSession session, String code) {
		return userService.register(buser, model, session, code);
	}
	@RequestMapping("/login")
	public String login(@ModelAttribute @Valid Buser buser, Model model, HttpSession session, String code) {
